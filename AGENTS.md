...
- Run `pnpm smoke:tui` when changing full-screen layout, session-mode overlays, composer popups, or keybindings that must be visible on the rendered 80x30 grid.
