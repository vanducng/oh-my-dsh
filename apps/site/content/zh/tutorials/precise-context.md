---
description: 用 @ 提及把 omdsh 指向精确的文件和会话，粘贴剪贴板图片，并编写结构化的多行 Prompt。
---
...
- 获准的图片按 2048×2048 总像素预算、8192px 长边上限与 4 MiB 编码体积目标存储。以像素预算为准，因此极端长宽比会保留其短边分辨率，而不会被压到 2048px 长边。
